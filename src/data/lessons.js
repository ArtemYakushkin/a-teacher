...
export const lessonsData = [
    {
        id: 1,
        linkVideo: "https://youtu.be/OkrLZo9t20k",
        posterImg: Poster0,
        title: "Знайомство",
        text: "В цьому відео Анна вітається з дітьми, представляє свого друга, питає як справи і діти починають читати англійською. Яке буде перше слово? Давайте подивимось! ",
        subText: "Коли закінчите перегляд відео — надішліть фото в Instagram з ім'ям дитини англійською з тегом #EnglishTodayWithAnna і напишіть слово 'START'.",
        img: Img0,
...

    {
        ...
        subText: "Коли закінчите поробку — надішліть фото/відео в Instagram Вашої поробки з тегом #EnglishTodayWithAnna і напишіть слово 'hedgehog'.",
        img: Img1,
